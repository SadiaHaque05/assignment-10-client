...
const Navbar = () => {
  ...
  const links = [
    ...
    <li key="explore"><NavLink to="/exploreArt">Explore All Artworks</NavLink></li>,
    <li key="add"><NavLink to="/addArt">Add Artwork</NavLink></li>,
    <li key="gallery"><NavLink to="/myGallery">My Gallery</NavLink></li>,
    <li key="favorites"><NavLink to="/myFavorites">My Favorites</NavLink></li>,
  ];
